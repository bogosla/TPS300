...
/**
 * Function description of TP_NewListBox() �� initialization for list box
...
/**
 * Function Description of TP_ListBoxAddItem()��initialization for list box
 * @param ListBox  items
...
//����Item��ָ����λ��
//��TP_ListBoxAddItem��ͬ���Ƕඨ����һ�������λ�ã�����������Ҫ���ӵ���Ŀ
                                ...
                                Boolean UpdateNow)
{
    ...
    if( index >= ListBox->ItemCount )//����itemcount���ŵ������
    {
    ...
    //�����������ƶ�
    tempi=(ListBox->ItemCount<LISTBOX_MAX_COUNT) ? ListBox->ItemCount : (ListBox->ItemCount-1);//��ֹԽ��
...
/**
 * Function description of DrawListBox() ��draw list items
...
//  if (ListBox->Button != NULL)
    ...
    else
    {
        ...
        if( (ListBox->CurrPage+MaxRowOnePage-1)>=ListBox->ItemCount)//��ʾ��ĩβ
        {
    ...
    while (Count < MaxRowOnePage)
    {
        ...
        if ( ListBox->ifDrawScrBall )
        {
            ...
            BlockHight = (float)(ScrBarRect.bottom - ScrBarRect.top) / ListBox->ItemCount;//�ڿ�߶�
...
/**
 * Function descripton of TP_ListBoxFree() ��release list items
 * @param ListBox  list items
 * @return None
 * @author  Zuo Jun
 * @version 1.0
