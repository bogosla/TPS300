...
Boolean TP_SetDate()
{
    ...
    while (TRUE)
    {
        ...
        TP_LcdPrintf("ȡ��");
    #else
        TP_LcdPrintf((uint8*)"Mete Dat ak Le");
            ...
            else if (keycode == TP_KEY_OK)
            {
                ...
                switch (inputback)
                {
                    ...
                    case 0:
                        break;
                    case 1:
                        TP_PopupMessageTimed((uint8*)"��ݳ���",1000);
                        break;
                    case 2:
                        TP_PopupMessageTimed((uint8*)"�·ݳ���",1000);
                        break;
                    case 3:
                        TP_PopupMessageTimed((uint8*)"�ճ���",1000);
                        break;
                    case 4 :
                        TP_PopupMessageTimed((uint8*)"Сʱ����",1000);
                        break;
                    case 5 :
                        TP_PopupMessageTimed((uint8*)"���ӳ���",1000);
                        break;
                    case 6 :
                        TP_PopupMessageTimed((uint8*)"�����",1000);
                        break;
                    case 7 :
                        TP_PopupMessageTimed((uint8*)"��Ч����",1000);
                        break;
             #else
                    case 0:
                        break;
